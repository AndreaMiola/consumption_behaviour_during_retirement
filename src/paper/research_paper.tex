...
\\\hspace*{4mm} This paper is structured as follows. Section 2 describe the dataset I used for the estimation, poiting out the assumption and how I worked with data. Section 3 reports the estimation strategy and the identification of the analysis. Section 4 reports the results and the conclusion.
...
\begin{figure}[h]
\centering
\includegraphics[width=0.55\textwidth]{CI_job_Retired.pdf}
...
\begin{figure} [h]
\centering
\includegraphics[width=0.55\textwidth]{CI_exret.pdf}
\caption{Confidence Interval of Exepected Ret. per years classes.}
\end{figure}
...
\section{Appendix}
\label{sec:appendix}
 \input{main_regression_exret.tex}
\input{main_regression_job_Retired.tex}
\clearpage
